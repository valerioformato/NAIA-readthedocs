...
(`see doxygen <https://naia-docs.web.cern.ch/naia-docs/v0.1.3/classNAIA_1_1SingleTreeChain.html#a57cbc933537adfa7dff2080d582>`_). 

``CreateSkimTree`` will return a ``SkimTreeHandle`` `object <https://naia-docs.web.cern.ch/naia-docs/v0.1.3/classNAIA_1_1SkimTreeHandle.html>`_. 
