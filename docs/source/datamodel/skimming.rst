...
(`see doxygen <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/classNAIA_1_1NAIAChain.html#aeca79ddd1a0f42ede2f82642087d91ed>`_). 

``CreateSkimTree`` will return a ``SkimTreeHandle`` `object <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/classNAIA_1_1SkimTreeHandle.html>`_. 
