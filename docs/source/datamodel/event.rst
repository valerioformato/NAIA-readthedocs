...
.. list-table:: Event class layout
   ...
   * - Container type
     - Name
     - Description
   * - `Header <https://naia-docs.web.cern.ch/naia-docs/v1.0.1/classNAIA_1_1HeaderData.html>`_
     - header
   ...
   * - `DAQ <https://naia-docs.web.cern.ch/naia-docs/v1.0.1/classNAIA_1_1DAQData.html>`_
     - daq
     - Contains variables describing the status of the AMS DAQ system for the event.
   * - `TofBase <https://naia-docs.web.cern.ch/naia-docs/v1.0.1/classNAIA_1_1TofBaseData.html>`_
     - tofBase
   ...
   * - `MCTruthPlus <https://naia-docs.web.cern.ch/naia-docs/v1.0.1/classNAIA_1_1MCTruthPlusData.html>`_
     - mcTruthPlus
...
.. note::
    ...
    When navigating the `doxygen documentation <https://naia-docs.web.cern.ch/naia-docs/v1.0.1/annotated.html>`_ 
...
``Category`` `mask <https://naia-docs.web.cern.ch/naia-docs/v1.0.1/group__contvar.html#ga3961a0a915ed84b69299200e51bd6242>`_ 
in the ``Header`` container.

.. note::
    To check if an event belongs in a given set of categories you can use the ``Header::CheckMask`` `method <https://naia-docs.web.cern.ch/naia-docs/v1.0.1/classNAIA_1_1HeaderData.html#a2b7f7c8fac62c48b1b71d71e88125989>`_. 
