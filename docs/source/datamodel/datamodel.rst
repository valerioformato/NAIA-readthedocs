...
`class <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/classNAIA_1_1RTIInfo.html>`_, one for each second of the current run.
...
This tree has one branch, which contains objects of the ``FileInfo`` `class <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/classNAIA_1_1FileInfo.html>`_ 
and, if the NAIA root-file is a Montecarlo file, an additional branch containing objects of the 
``MCFileInfo`` `class <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/classNAIA_1_1MCFileInfo.html>`_.
...
* ``EcalEnergyVariable``: one number for each energy reconstruction type.
  ...
  * Uses the ``Ecal::EnergyRecoType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1Ecal.html>`_ for access
  * .. code-block:: cpp
...
* ``EcalLikelihoodVariable``: one number for each likelihood type.
  ...
  * Uses the ``Ecal::LikelihoodType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1Ecal.html>`_ for access
  * .. code-block:: cpp
...
* ``EcalBDTVariable``: one number for each BDT type.
  ...
  * Uses the ``Ecal::BDTType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1Ecal.html>`_ for access
  * .. code-block:: cpp
...
* ``RichBetaVariable``: one number for each RICH beta reconstruction type.
  ...
  * Uses the ``Rich::BetaType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1Rich.html>`_ for access
  * .. code-block:: cpp
...
* ``TofChargeVariable``: one number for each kind of Tof charge.
  ...
  * Uses the ``Tof::ChargeType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1Tof.html>`_ for access
  * .. code-block:: cpp
...
* ``TofBetaVariable``: one number for each Tof beta reconstruction type.
  ...
  * Uses the ``Tof::BetaType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1Tof.html>`_ for access
  * .. code-block:: cpp
...
* ``TofClusterTypeVariable``: one number for each Tof cluster type.
  ...
  * Uses the ``Tof::BetaClusterType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1Tof.html>`_ for access
  * .. code-block:: cpp
...
* ``TrdChargeVariable``: one number for each TRD charge reconstruction type.
  ...
  * Uses the ``TrdK::ChargeType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrdK.html>`_ for access
  * .. code-block:: cpp
...
* ``TrdLikelihoodVariable``: one number for each TRD likelihood type.
  ...
  * Uses the ``TrdK::LikelihoodType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrdK.html>`_ for access
  * .. code-block:: cpp
...
* ``TrdLikelihoodRVariable``: one number for each TRD likelihood ratio type.
  ...
  * Uses the ``TrdK::LikelihoodRType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrdK.html>`_ for access
  * .. code-block:: cpp
...
* ``TrdOnTrackVariable``: one number for on-track / off-track TRD hits.
  ...
  * Uses the ``TrdK::QualType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrdK.html>`_ for access
  * .. code-block:: cpp
...
* ``TrackChargeVariable``: one number for each Tracker charge reconstruction type.
  ...
  * Uses the ``TrTrack::ChargeRecoType`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrTrack.html>`_ for access
  * .. code-block:: cpp
...
* ``TrackFitVariable``: one number for each track fitting type, and for each track span type.
  ...
  * Uses the ``TrTrack::Fit`` and ``TrTrack::Span`` `enums <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrTrack.html>`_ for access
  * .. code-block:: cpp
...
* ``TrackFitOnlyVariable``: one number for each Track fit type.
  ...
  * Uses the ``TrTrack::Fit`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrTrack.html>`_ for access
  * .. code-block:: cpp
...
* ``TrackSideVariable``: one number for each Tracker side.
  ...
  * Uses the ``TrTrack::Side`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrTrack.html>`_ for access
  * .. code-block:: cpp
...
* ``TrackFitPosVariable``: one number for each fixed z-position in the Tracker.
  ...
  * Uses the ``TrTrack::FitPositionHeight`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrTrack.html>`_ for access
  * .. code-block:: cpp
...
* ``TrackDistanceVariable``: one number for each distance-from-the-track type.
  ...
  * Uses the ``TrTrack::DistanceFromTrack`` `enum <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/namespaceNAIA_1_1TrTrack.html>`_ for access
  * .. code-block:: cpp
...
Please refer to the `doxygen documentation <https://naia-docs.web.cern.ch/naia-docs/v1.1.0/annotated.html>`_ for all the details.
